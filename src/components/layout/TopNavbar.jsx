    ...
    <header className="border-b border-[#E8EAF0] bg-white">
      <div className="mx-auto flex h-[76px] max-w-[1280px] items-center justify-between px-6 lg:px-8">
        ...
        <Link href="/dashboard" className="flex items-center gap-2.5">
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#5B3CC4] text-white shadow-sm">
            <Sparkles size={19} strokeWidth={2.2} />
          </div>

          <div>
            <p className="text-[17px] font-bold tracking-[-0.02em] text-[#18212F]">
              Kudos Card
            </p>
